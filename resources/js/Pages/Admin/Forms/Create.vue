        ...
        <form @submit.prevent="submit" class="mt-8 space-y-6 max-w-4xl bg-white p-6 rounded-lg shadow">
            ...
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input v-model="form.key" type="text" id="key" :class="errors.key
                            ? 'ring-red-300 focus:ring-red-600'
                            : 'ring-gray-300 focus:ring-indigo-600'"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6"
                    ...
                    <p class="mt-1 text-xs text-gray-400">
                        Identificador único usado en el código. No puede cambiarse después.
                    </p>
                    <div v-if="errors.key" class="mt-2 text-sm text-red-600">{{ errors.key }}</div>
                </div>
                ...
                <div class="sm:col-span-4">
                    ...
                    <div class="mt-2">
                        <input v-model="form.recipient_email" type="email" id="recipient_email" :class="errors.recipient_email
                            ...
                            : 'ring-gray-300 focus:ring-indigo-600'"
                            class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6"
                            placeholder="info@termosalud.com" />
                    </div>
                ...
                <div class="sm:col-span-6">
                    <div class="flex items-center gap-3">
                        ...
                        <label for="active" class="text-sm font-medium text-gray-900">Formulario Activo</label>
                    </div>
                </div>
                ...
                <div class="sm:col-span-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-if="form.fields.length === 0"
                            class="text-sm text-gray-500 text-center py-4 border-2 border-dashed border-gray-300 rounded-md">
                            No hay campos definidos. Añade al menos uno.
                        </div>
                    </div>
                </div>
...
const submit = async () => {
    ...
    try {
        await api.post('/api/v1/forms', form.value);
