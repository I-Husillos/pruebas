<template>
  <AdminLayout>
    ...
    <div class="max-w-4xl">
      <h1 class="text-3xl font-bold text-gray-900 mb-8">Crear Menú</h1>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div v-show="activeLang === 'es'" class="space-y-6">
            ...
            <div>
              ...
              <input v-model="form.key" type="text" :class="{'border-red-300 focus:border-red-500 focus:ring-red-500': form.errors.key}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm font-mono" required placeholder="main-menu" />
              <p v-if="form.errors.key" class="mt-1 text-sm text-red-600">{{ form.errors.key }}</p>
              <p class="mt-1 text-xs text-gray-500">Identificador único para el menú (ej: main-menu, footer-menu)</p>
            </div>
            <div>
