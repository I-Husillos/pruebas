...
const form = useForm({
    market_code: props.page.marketCode,
    language_code: props.page.languageCode,
    slug: props.page.slug,
    is_active: !!props.page.isActive,
    seo_title: props.page.seoTitle || '',
    seo_description: props.page.seoDescription || '',
    meta_keywords: props.page.metaKeywords || '', // Added metaKeywords if present in prop, otherwise string
    blocks_json: props.page.blocks || [],
});
