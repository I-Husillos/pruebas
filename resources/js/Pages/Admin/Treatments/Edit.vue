    ...
    <div class="md:flex md:items-center md:justify-between mb-8">
      <div class="min-w-0 flex-1">
        <h2 class="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
          Editar Tratamiento: {{ treatment.name.es || treatment.name.en }}
        </h2>
      </div>
    </div>
        ...
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-3">
              ...
              <div class="mt-1">
                <input v-model="form.sort_order" type="number" id="sort_order" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" />
              </div>
            </div>
          </div>
        </div>
...
const form = ref({
  ...
  available_markets: props.treatment.available_markets || ['es'],
  category_id: props.treatment.category_id || null,
