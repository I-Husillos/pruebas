    ...
    <form @submit.prevent="submit" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="space-y-8">
        <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <div class="space-y-4">
            <div>
              ...
              <p v-if="errors.treatment_category_id" class="mt-1 text-sm text-red-600">{{ errors.treatment_category_id }}</p>
            </div>
        ...
        <div class="flex justify-end gap-3 pt-4">
          ...
          >
            {{ processing ? 'Guardando...' : 'Guardar Tratamiento' }}
          </button>
        </div>
      </div>
    </form>
...
const { errors, processing, submitCreate } = useTreatmentForm({
  api,
