    ...
    <div class="border rounded-md p-4 bg-white">
        ...
        <div v-else class="relative group">
            ...
            <div v-if="data.type === 'image'"
                class="relative aspect-w-16 aspect-h-9 bg-gray-100 rounded-md overflow-hidden">
            ...
            <div class="absolute top-2 right-2 flex gap-2">
                <button type="button" @click="removeMedia"
                    class="p-1 bg-red-600 text-white rounded-full hover:bg-red-700 shadow-sm" title="Eliminar">
            ...
            <div class="mt-2 space-y-2">
                <input v-model="data.caption" type="text" placeholder="Pie de foto / Descripción (Alt)"
