...
final class LanguagesResponse implements Response
{
    ...
    public function __construct(array $languages, int $total, int $limit, int $offset)
    {
    ...
    public function toArray(): array
    {
        ...
        return [
            'records' => array_map(fn(LanguageResponse $language) => $language->toArray(), $this->languages),
