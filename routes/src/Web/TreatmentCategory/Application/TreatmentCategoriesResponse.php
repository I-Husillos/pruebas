...
final class TreatmentCategoriesResponse implements Response
{
    /** @var TreatmentCategoryResponse[] */
    ...
    public function toArray(): array
    {
        ...
        return [
            'records' => array_map(fn(TreatmentCategoryResponse $response) => $response->toArray(), $this->categories),
