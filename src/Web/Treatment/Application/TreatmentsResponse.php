...
final class TreatmentsResponse implements Response
{
    ...
    public function __construct(array $treatments, int $total, int $limit, int $offset)
    {
    ...
    public function toArray(): array
    {
        ...
        return [
            'records' => array_map(fn(TreatmentResponse $response) => $response->toArray(), $this->treatments),
